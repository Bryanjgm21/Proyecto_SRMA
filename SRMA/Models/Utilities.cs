...
namespace SRMA.Models
{
    public class Utilities : IUtilities
    {
        ...
        public string ArmarHTML(UserEntity datos, string tempPassword)
        {
            string rutaArchivo = Path.Combine(_hostingEnvironment.ContentRootPath, "MailTemplates\\Contrasenna.html");
